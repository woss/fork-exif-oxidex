...
**TL;DR**: OxiDex is a production-ready, memory-safe Rust reimplementation of ExifTool delivering 13-65x performance improvements over the Perl implementation. Install with `cargo install oxidex` or download binaries from [GitHub Releases](https://github.com/oxidex/oxidex/releases/tag/v1.0.0).

---

## Introduction

I'm excited to announce the v1.0.0 stable release of **OxiDex**, a modern, high-performance Rust reimplementation of the industry-standard [ExifTool](https://exiftool.org/) metadata management library and command-line application.

After several months of development spanning five iterations, OxiDex has reached production readiness with comprehensive features, extensive testing, and exceptional performance.

## What is OxiDex?

OxiDex provides powerful metadata extraction, editing, and management for 50+ file formats including JPEG, PNG, TIFF, PDF, MP4/QuickTime, and RAW camera formats. It's designed as a drop-in replacement for Perl ExifTool in 90% of common use cases while delivering dramatically better performance through compiled code and parallel processing.

## Key Features

### 🚀 Exceptional Performance

OxiDex delivers **13-65x speedup** over Perl ExifTool (version 13.36) on real-world workloads:
...
Built in Rust, OxiDex eliminates entire classes of security vulnerabilities:
...
OxiDex provides self-contained static binaries with **zero runtime dependencies**:
...
Download platform-specific binaries from [GitHub Releases](https://github.com/oxidex/oxidex/releases/tag/v1.0.0):
...
**Debian/Ubuntu (.deb)**:
```bash
wget https://github.com/oxidex/oxidex/releases/download/v1.0.0/oxidex_1.0.0_amd64.deb
sudo apt install ./oxidex_1.0.0_amd64.deb
```

**Fedora/RHEL (.rpm)**:
```bash
wget https://github.com/oxidex/oxidex/releases/download/v1.0.0/oxidex-1.0.0-1.x86_64.rpm
sudo dnf install oxidex-1.0.0-1.x86_64.rpm
```
...
# Write metadata
oxidex -Artist="Your Name" -Copyright="2025" photo.jpg
...
oxidex "-DateTimeOriginal+=0:0:1 0:0:0" photo.jpg
```
...
lib = ctypes.CDLL('./target/release/liboxidex.so')
...
OxiDex is designed for **90% CLI backward compatibility** with Perl ExifTool. Most common workflows work as drop-in replacements:

### Compatible Operations
✅ Read metadata: `oxidex photo.jpg`
✅ Write tags: `oxidex -Artist="Name" photo.jpg`
✅ Batch processing: `oxidex -r /photos/`
✅ JSON output: `oxidex -json photo.jpg`
✅ Copy metadata: `oxidex -TagsFromFile source.jpg target.jpg`
...
For detailed migration guidance, see the [User Guide](https://oxidex.github.io/oxidex/).

## Architecture Highlights

OxiDex follows a **Hexagonal Architecture** (Ports and Adapters) with clean separation of concerns:
...
OxiDex has comprehensive quality controls:
...
- 💻 [GitHub Repository](https://github.com/oxidex/oxidex)
- 📥 [Download Binaries](https://github.com/oxidex/oxidex/releases/tag/v1.0.0)
