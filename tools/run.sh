#!/usr/bin/env bash
#
# run.sh - Run the exiftool-rs application
#
# This script ensures dependencies are installed and then runs the main
# application binary.
#
# Exit codes:
#   0 - Success
#   Non-zero - Application error or setup failure
...
main() {
    ...
    # Run the application with all script arguments
    run_application "$@"
}
