...
| `EXIF:StripByteCounts` | 1048 |
| `EXIF:StripOffsets` | 3816 |
...
| `IFD0:RowsPerStrip` | 120 |
| `IFD0:SamplesPerPixel` | 3 |
| `IFD0:Software` | GraphicConverter |
| `IFD0:StripByteCounts` | 1048 |
| `IFD0:StripOffsets` | 3816 |
| `IFD0:SubfileType` | 0 |
| `IFD0:XResolution` | 1800/10 |
| `IFD0:YResolution` | 1800/10 |
