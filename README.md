...
- **16-65x faster** than Perl ExifTool ([see benchmarks](https://oxidex.net/benchmarks/report/index.html))
...
- [Live Benchmarks](https://oxidex.net/benchmarks/report/index.html) - Performance comparison with Perl ExifTool
