...
| `EXIF:ComponentsConfiguration` | -, -, -, - | (Binary data 4 bytes, use -b option to e... |
...
| `MakerNotes:AutoISO` | 100 | 32767 |
| `MakerNotes:BaseISO` | 400 | 224 |
| `MakerNotes:CameraISO` | Auto | 224 |
| `MakerNotes:CanonExposureMode` | Aperture-priority AE | Aperture Priority |
| `MakerNotes:CanonFirmwareVersion` | Firmware 1.0.2 | DJMI***3:A›949VO |
| `MakerNotes:CanonImageType` | Canon EOS 350D DIGITAL | 7FK;)C.31:2 |
| `MakerNotes:ControlMode` | Camera Local Control | Unknown (1) |
| `MakerNotes:FirmwareVersion` | 1.0.0 | DJMI***3:A›949VO |
| `MakerNotes:FlashActivity` | 0 | Did not fire |
...
| `MakerNotes:MeasuredEV` | 8.0 | 3.00 |
...
| `MakerNotes:GrainyBWFilter` | Off |
| `MakerNotes:HDR` | Off |
| `MakerNotes:HDREffect` | Natural |

*...and 140 more missing tags*
